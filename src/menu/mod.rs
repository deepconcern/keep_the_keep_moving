...
fn animate_buttons(
    mut button_query: Query<
        (&mut BackgroundColor, &mut BorderColor, &Children, &Interaction),
...
fn start_game_button(button_query: Query<&Interaction, (Changed<Interaction>, With<Button>)>, mut next_state: ResMut<NextState<AppState>>) {
...
impl Plugin for MenuPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(Update, (animate_buttons, start_game_button).run_if(in_state(AppState::Menu)));
    }
}
